package com.breezenishantpoly.features.mylearning.apiCall

import com.breezenishantpoly.app.NetworkConstant
import com.breezenishantpoly.base.BaseResponse
import com.breezenishantpoly.features.addshop.model.AddQuestionSubmitRequestData
import com.breezenishantpoly.features.leaderboard.api.LeaderboardOverAllData
import com.breezenishantpoly.features.leaderboard.api.LeaderboardOwnData
import com.breezenishantpoly.features.login.api.opportunity.OpportunityListApi
import com.breezenishantpoly.features.login.model.opportunitymodel.OpportunityStatusListResponseModel
import com.breezenishantpoly.features.mylearning.CONTENT_WISE_QA_SAVE
import com.breezenishantpoly.features.mylearning.ContentCountSave_Data
import com.breezenishantpoly.features.mylearning.LMSLeaderboardOverAllData
import com.breezenishantpoly.features.mylearning.LMSLeaderboardOwnData
import com.breezenishantpoly.features.mylearning.LMS_CONTENT_INFO
import com.breezenishantpoly.features.mylearning.MyCommentListResponse
import com.breezenishantpoly.features.mylearning.MyLarningListResponse
import com.breezenishantpoly.features.mylearning.TopicListResponse
import com.breezenishantpoly.features.mylearning.VideoTopicWiseResponse
